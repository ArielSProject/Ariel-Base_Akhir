...
case prefix+'command' : {
let sections = []
let listmenu = [`catalog`,`menu`,`grupmenu`,`textpromenu`,`stickertelegram`,`convertmenu`,`searchmenu`,`downloadmenu`,`storemenu`,`randomtext`,`stalkmenu`,`animemenu`,`funmenu`,`infomenu`,`toolsmenu`,`ownermenu`,`othermenu`]
